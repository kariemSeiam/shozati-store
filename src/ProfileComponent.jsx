...
const SheetHeader = memo(({ onClose, title, hideSupport, onSupportClick }) => (
  <div className="pt-8 px-4 pb-4 border-b border-neutral-200 flex-shrink-0">
    <div className="flex items-center justify-between">
      <button
        onClick={onClose}
        className="p-2 rounded-xl bg-neutral-50 text-slate-600 hover:bg-neutral-100 hover:text-slate-800 transition-all duration-200"
      >
        <X className="w-5 h-5" />
      </button>
      ...
      <BottomSheet isOpen={isOpen} onClose={onClose} title="الملف الشخصي">
        <div className="divide-y divide-slate-100/30">
          ...
          <div className="relative px-4 pt-8 pb-6 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-primary-500/10 to-primary-400/10 
                  transform -skew-y-6" />
            <div className="absolute top-20 right-0 w-32 h-32 bg-gradient-to-br from-primary-400/20 to-transparent 
                  rounded-full blur-2xl" />
            <div className="absolute top-10 left-0 w-24 h-24 bg-gradient-to-br from-primary-400/20 to-transparent 
                  rounded-full blur-xl" />

            <div className="relative flex flex-col items-center">
              {/* Innovative Avatar Container */}
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-primary-400 to-primary-500 
                ...
                {/* Main avatar */}
                <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-primary-400 via-primary-500 to-primary-600
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-primary-600/10 via-transparent to-primary-700/10" />
              ...
              {statsData.map((stat, index) => (
                ...
                >
                  ...
                  <div className="relative flex items-center gap-3">
                    {/* Icon container */}
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-100 to-primary-200 
                          flex items-center justify-center group-hover:scale-105 transition-transform
                          shadow-sm group-hover:shadow-md relative overflow-hidden border border-primary-200/30">
                      <div className="absolute inset-0 bg-gradient-to-br from-white/50 to-transparent" />
                      <stat.icon className="w-5 h-5 text-primary-600 relative z-10 
                    ...
                    <div className="flex-1 text-right">
                      ...
                      <p className="text-lg font-bold text-slate-800 group-hover:text-primary-600
                            transition-colors duration-300">{stat.count}</p>
                    </div>
                  </div>
                </button>
              ))}
          ...
          <div className="relative px-4 py-4 space-y-3">
            ...
            {profileSections.map(section => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary-50 to-primary-100 
                      opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="absolute inset-0 bg-gradient-to-br from-primary-400/5 via-transparent to-primary-500/5 
                      opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                <div className="relative flex items-center justify-between">
                  <button
                    onClick={section.onEdit}
                    className="p-2 rounded-lg bg-gradient-to-br from-primary-50 to-primary-100 hover:from-primary-100 hover:to-primary-200
                          transition-all duration-300 group-hover:shadow-sm group border border-primary-200/50"
                  >
                    <Edit2 className="w-3.5 h-3.5 text-primary-600 group-hover:rotate-12 transition-transform" />
                  </button>
                  ...
                  <div className="flex items-center gap-3 text-right">
                    ...
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-100 to-primary-200 
                          ...
                          shadow-sm group-hover:shadow-md relative overflow-hidden border border-primary-200/30">
                      <div className="absolute inset-0 bg-gradient-to-br from-white/50 to-transparent" />
                      <section.icon className="w-5 h-5 text-primary-600 relative z-10 
                            transform group-hover:rotate-12 transition-transform duration-300" />
                    </div>
                  </div>
                </div>
          ...
          <div className="relative p-4 space-y-3" dir="rtl">
            <button
              ...
              className="w-full bg-gradient-to-r from-primary-50 via-primary-100 to-primary-50 
                    rounded-xl p-4 flex items-center justify-between group
                    hover:shadow-lg transition-all duration-300 relative overflow-hidden border border-primary-200/30"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-primary-100/50 to-primary-200/50 
                    opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="relative flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-100 to-primary-200 
                      flex items-center justify-center group-hover:scale-105 transition-transform
          ...
          {steps.map((s, i) => (
            <div key={s.id} className="flex items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center
                  ...
                  step > s.id ? 'bg-primary-200 text-primary-600' : 'bg-primary-50 text-primary-400'}`}>
                {step > s.id ? (
              ...
              {i < steps.length - 1 && (
                <div className={`h-0.5 w-16 
                                          ${step > s.id ? 'bg-primary-200' : 'bg-primary-50'}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="flex gap-3">
          {step > 1 && (
            <button
              ...
              className="flex-1 bg-primary-50 text-primary-700 rounded-xl py-3
    ...
    >
      <div className="p-6 space-y-8">
        ...
        <div className={`w-24 h-24 rounded-full mx-auto 
                    ...
                    bg-gradient-to-br from-primary-400 to-primary-500 shadow-md`}
        >
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-primary-50 text-primary-800 rounded-xl p-4 
                                ...
                                focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500
                                placeholder-primary-300 transition-all duration-300"
              dir="ltr"
            />
            {phone && (
